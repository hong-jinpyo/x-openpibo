...
def walk():
  oled_display(openpibo.data_path+"images/icon/walk.png")
...
def weather():
  oled_display(openpibo.data_path+"images/icon/weather.png")
...
def conversation(_text):
  print("대화:", _text)
  oled_display(openpibo.data_path+"images/icon/conversation.png")
...
if __name__ == "__main__":
  pibo.eye_on('aqua')
  oled_display(openpibo.data_path+"images/icon/pibo_logo.png")
  ...
  while True:
    if time.time() - start > 1:
      ...
      if ret['data']['TOUCH'] == 'touch':
        oled_display(openpibo.data_path+"images/icon/mic.png")
