...
def walk():
  oled_display(cfg.IMAGES_TESTDATA_PATH +"/icon/walk.png")
...
def weather():
  oled_display(cfg.IMAGES_TESTDATA_PATH +"/icon/weather.png")
  ...
  pibo.draw_image(cfg.IMAGES_TESTDATA_PATH + "/icon/weather_bot.png")
  pibo.show_display()
...
def dance():
  oled_display(cfg.IMAGES_TESTDATA_PATH +"/icon/check.png")
...
def conversation(_text):
  print("대화:", _text)
  oled_display(cfg.IMAGES_TESTDATA_PATH +"/icon/conversation.png")
...
if __name__ == "__main__":
  pibo.eye_on('aqua')
  oled_display(cfg.IMAGES_TESTDATA_PATH +"/icon/pibo_logo.png")
  ...
  while True:
    if time.time() - start > 1:
      ...
      if ret['data']['TOUCH'] == 'touch':
        oled_display(cfg.IMAGES_TESTDATA_PATH +"/icon/mic.png")
